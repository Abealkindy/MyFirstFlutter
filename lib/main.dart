    ...
    return new Scaffold(
      ...
      body: new Center(
        ...
        child: new Column(
          ...
          children: <Widget>[
            new Text(
              'Kamu sudah memencet tombol ini selama:',
            ),
            new Text(
              '${_counter}',
